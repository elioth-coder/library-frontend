...
>
  <Navbar color="default">
    <div class="flex w-fit items-center justify-start">
      <NavBrand href="#/web_opac" class="ms-2 md:me-24">
        ...
        >
          NEUST O<i class="font-normal text-sm">nline</i>
          P<i class="font-normal text-sm">ublic</i>
          A<i class="font-normal text-sm">ccess</i>
          C<i class="font-normal text-sm">atalogue</i>
        </span>
      </NavBrand>
    </div>
