<script>
  ...
  import LibraryCardCrudTable from "./LibraryCardCrudTable.svelte";
  import CrudToolbar from "../CrudToolbar.svelte";
  import LibraryCardForm from "./LibraryCardForm.svelte";
  import FormContainerModal from "../FormContainerModal.svelte";

  let table_name = "library_card";
  let columns = [
    "id",
    "card_number",
    "email",
  ...
  let service = new LibraryCardService();
  let modalSize = "md";
...
>
  <LibraryCardForm {processing} item={selectedItem} on:submit={submitItem} />
</FormContainerModal>
